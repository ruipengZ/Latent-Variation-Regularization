...
from custom_env.unitree_rl_lab.assets.robots import unitree_actuators
...
UNITREE_MODEL_DIR = (Path(__file__).resolve().parents[2] / "unitree_model")
...
UNITREE_GO2_REAL_CFG = UnitreeArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{UNITREE_MODEL_DIR}/Go2/usd/go2.usd",
        activate_contact_sensors=True,
        rigid_props=sim_utils.RigidBodyPropertiesCfg(
    ...
    actuators={
        "GO2HV": unitree_actuators.UnitreeActuatorCfg_Go2HV(
            ...
            #     ".*_thigh_joint":3.0,
            #     "FL_calf_joint":2.0,
            #     "FR_calf_joint":2.200000047683716,
            #     "RL_calf_joint":2.200000047683716,
            #     "RR_calf_joint":2.0,
            # },
            # damping={
            #     ".*_hip_joint":1.7999999523162842,
            #     "FL_thigh_joint": 2.0,
            #     "FR_thigh_joint": 0.800000011920929,
            #     "RL_thigh_joint": 0.800000011920929,
            #     "RR_thigh_joint": 2.0,
            #     "FL_calf_joint": 1.5,
            #     "FR_calf_joint": 1.2000000476837158,
            #     "RL_calf_joint": 1.2000000476837158,
            #     "RR_calf_joint": 1.5,
            #
            #     # ".*_hip_joint": 0.3,
            #     # "FL_thigh_joint": 0.5,
