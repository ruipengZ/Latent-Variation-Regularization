...
def save_frames_as_gif(frames, path='./', filename='gym_animation.gif'):
    ...
    plt.figure(figsize=(frames[0].shape[1] / 256.0, frames[0].shape[0] / 256.0))
    ...
    print('gif saved at: ' + path + filename)
...
class Collector(object):
    ...
    def collect(
        ...
        while True:
            ...
            if render:
                self.render_frames.append(self.env.render()[0])
            ...
            if np.any(done):
                ...
                # ) # todo: remove this reset cause Isaac has already reset envs
